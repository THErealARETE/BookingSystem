# Generated by Django 3.0.5 on 2020-11-24 13:59
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ('State_name', models.CharField(choices=[('first', 'Pick an available state'), ('AB', 'Abia'), ('AD', 'Adamawa'), ('AK', 'Akwa Ibom'), ('AN', 'Anambra'), ('BA', 'Bauchi'), ('BY', 'Bayelsa'), ('BN', 'Benue'), ('BO', 'Borno'), ('CR', 'Cross River'), ('DT', 'Delta'), ('EB', 'Ebonyi'), ('ED', 'Edo'), ('EK', 'Ekiti'), ('EN', 'Enugu'), ('FCT', 'Abuja'), ('GM', 'Gombe'), ('IM', 'Imo'), ('JG', 'Jigawa'), ('KD', 'Kaduna'), ('KN', 'Kano'), ('KT', 'Kastina'), ('KB', 'Kebbi'), ('KG', 'Kogi'), ('KW', 'Kwara'), ('LA', 'Lagos'), ('NS', 'Nassarawa'), ('NG', 'Niger'), ('OG', 'Ogun'), ('OD', 'Ondo'), ('OS', 'Osun'), ('OY', 'Oyo'), ('PL', 'Plateau'), ('RV', 'Rivers'), ('SO', 'Sokoto'), ('TR', 'Taraba'), ('YB', 'Yobe'), ('ZM', 'Zamfara')], default='first', max_length=500)),
                ('state_number', models.AutoField(primary_key=True, serialize=False, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state_number', models.IntegerField(unique=True)),
                ('state_name', models.CharField(max_length=50, null=True, unique=True)),
                ('state_camp_name', models.CharField(blank=True, max_length=200, null=True)),
                ('depart_date', models.DateField(blank=True, null=True, verbose_name='Depart Date')),
                ('arrive_date', models.DateField(blank=True, null=True, verbose_name='Arrive Date')),
                ('payment_link', models.CharField(blank=True, max_length=200, null=True)),
                ('departure_location', models.CharField(blank=True, max_length=50)),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('customers', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
